...
const Shop = () => {
	return (
		<div className='overflow-hidden'>
			<section
				className={`relative flex lg:py-10 justify-center items-center w-[100%] bg-black bg-opacity-40 min-h-[91vh] mb-10 text-white pt-10 xl:pt-0`}
			>
				<div>
					<Image
						src='/background.jpg'
				...
				>
					<div className='  relative grid grid-cols-1 lg:grid-cols-2 px-2 gap-5 lg:gap-0 '>
						<div className=' relative  lg:max-w-[500px] flex flex-col gap-1 lg:gap-4 text-center lg:text-start'>
							<h2 className='text-main-color font-bold text-lg lg:text-3xl my-3'>
								SKLEPY INTERNETOWE
							</h2>
							<p className='text-base lg:text-xl '>
								Nasze nowatorskie podejście, łączące
								innowacyjność z praktycznością, gwarantuje, że
								sklep internetowy, który dla Państwa stworzymy,
								będzie doskonale przyjęty przez potencjalnych
								klientów.
							</p>
					...
					<div className='  py-10 text-center lg:text-start px-1'>
						...
						<p className='text-base lg:text-xl max-w-[700px]  lg:px-0'>
							Całość formalności możemy dopełnić drogą
							telefoniczną lub e-mailową. Dzięki temu oszczędzisz
							swój czas oraz pieniądze. Zachęcamy do
